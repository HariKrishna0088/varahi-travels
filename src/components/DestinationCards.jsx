...
import { Users, Heart, Map, Sun } from 'lucide-react';
          ...
          {destinations.map(dest => (
            <Link to={`/destination/${dest.id}`} key={dest.id} className="dest-card animate-fade-in-up" style={{ animationDelay: `${dest.id * 0.1}s`, textDecoration: 'none', color: 'inherit', display: 'block' }}>
              ...
              <div className="dest-content">
                ...
                <div style={{ display: 'inline-block', background: '#0ea5e9', color: 'white', padding: '0.2rem 0.5rem', borderRadius: '0.25rem', fontSize: '0.75rem', fontWeight: 'bold', marginBottom: '0.75rem' }}>
                  Food & Stay Included
                </div>
